...
var mockRequest = function (bodyData, leadId) { return ({
    body: bodyData,
...
describe('Lead Controller', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    res = mockResponse();
                    return [4 /*yield*/, leadController_1.createLead(req, res, nextFunction)];
                case 1:
                    _a.sent();
    ...
    it('should update an existing lead', function () { return __awaiter(void 0, void 0, void 0, function () {
        var req, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    res = mockResponse();
                    return [4 /*yield*/, leadController_1.updateLead(req, res, nextFunction)];
                case 1:
                    _a.sent();
    ...
    it('should delete a lead', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req = mockRequest({}, 'leadToDeleteId');
                    res = mockResponse();
                    return [4 /*yield*/, leadController_1.deleteLead(req, res, nextFunction)];
                case 1:
                    _a.sent();
                    expect(res.status).toBeCalledWith(200);
                    expect(res.json).toBeCalledWith(expect.objectContaining({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req = mockRequest();
                    res = mockResponse();
                    return [4 /*yield*/, leadController_1.getAllLeads(req, res, nextFunction)];
                case 1:
                    _a.sent();
                    expect(res.status).toBeCalledWith(200);
