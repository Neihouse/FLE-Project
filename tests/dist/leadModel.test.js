    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    mongoUri = _a.sent();
                    return [4 /*yield*/, mongoose_1["default"].connect(mongoUri, { useNewUrlParser: true, useUnifiedTopology: true })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    lead = new leadModel_1["default"](leadData);
